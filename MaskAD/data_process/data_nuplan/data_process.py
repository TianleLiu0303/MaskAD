...
from MaskAD.data_process.data_nuplan.data_processor import DataProcessor
...
if __name__ == "__main__":
    ...
    with open('/mnt/pai-pdc-nas/tianle_DPR/MaskAD/config/nuplan_train.json', "r", encoding="utf-8") as file:
