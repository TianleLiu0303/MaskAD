...
import argparse
import pickle
from MaskAD.data_process.data_waymo.data_utils import *
...
if __name__ == '__main__': 
    ...
    parser.add_argument('--data_dir', type=str, default='/mnt/pai-pdc-nas/tianle_DPR/waymo/data_waymo/testing_module')
    parser.add_argument('--save_dir', type=str, default='/mnt/pai-pdc-nas/tianle_DPR/waymo/data_waymo/testing_module_processed')
