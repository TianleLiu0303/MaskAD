...
ARGS_FILE=/mnt/pai-pdc-nas/tianle_DPR/MaskAD/train_logs/20251209-161525/nuplan_experiment_IL/checkpoints/last.ckpt
CKPT_FILE=/mnt/pai-pdc-nas/tianle_DPR/MaskAD/planner/config/args.json
...
python $NUPLAN_DEVKIT_ROOT/nuplan/planning/script/run_simulation.py \
    ...
    hydra.searchpath="[pkg://MaskAD.config.scenario_filter, pkg://MaskAD.planner.config, pkg://nuplan.planning.script.config.common, pkg://nuplan.planning.script.experiments  ]"